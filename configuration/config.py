...
def get_train_config():
    parse = argparse.ArgumentParser(description='ACP-PDAFF train model')

    # preoject setting
    parse.add_argument('-learn-name', type=str, default='final_model', help='learn name')
    ...
    parse.add_argument('-reg', type=float, default=0.1, help='weight lambda of regularization')
    parse.add_argument('-batch-size', type=int, default=2048, help='number of samples in a batch')
